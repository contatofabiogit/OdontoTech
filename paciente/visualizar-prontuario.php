...
$query1 = "SELECT * FROM pessoa WHERE id_pessoa = $id";
$query2 = "SELECT * FROM paciente WHERE pessoa_id_pessoa = $id";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="homePrincipal col-md-4 text-center ">
                    <a href="main-paciente.php" class="hvr-grow-shadow"><img src="../images/botao-home-render.png" class="home">
                        <br>
