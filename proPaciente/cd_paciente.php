...
if (($nome == "") && ($cro == "") && ($especializacao == "") && ($login == "") &&
    ...
    if (validaCPF($cpf)) {
        ...
        $query2 = mysql_query("INSERT INTO paciente VALUES ('', '$nacionalidade', '$est_civil', '$local_nascimento', '$celular', '$profissao', '$nome_responsavel',
                '$tel_responsavel', '$endereco', '$bairro', '$complemento', '$cidade', '$estado', '$numero', LAST_INSERT_ID())");
