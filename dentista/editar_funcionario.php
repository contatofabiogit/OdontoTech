...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <form method="POST" action="../processamento/ed_funcionario.php">
                    ...
                    <div class="salvarPrincipal col-md-6 text-center">
                        ...
                        <div class="btn col-md-2">
                            <button type="submit" class="btn">
                                <a href="#" type="submit" class="hvr-float-shadow">
                        ...
                        <div class="btn col-md-2">
                            <button class="btn">
                                <a href="administrativo.php?link=11" type="submit" class="hvr-float-shadow">
                        ...
                        <div class="btn col-md-2">
                            <button class="btn">
                                <a href="../processamento/apg_funcionario.php?id=<?php echo $resultado1['id_pessoa']; ?>" class="hvr-float-shadow" data-toggle="modal" data-target="#Modal-Excluir">
