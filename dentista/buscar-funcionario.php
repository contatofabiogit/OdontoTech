...
<html lang="pt-br">
    ...
    <body>
        <?php
        $resultado = mysql_query("SELECT * FROM pessoa WHERE nivel_acesso = 'Atendente' OR nivel_acesso = 'Assistente'");
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        while ($linhas = mysql_fetch_array($resultado)) {
                            ...
                            ?>
                        <td>
                            <a href="administrativo.php?link=12&id=<?php echo $linhas['id_pessoa']; ?>">
