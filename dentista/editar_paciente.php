            ...
            <form method="POST" action="../processamento/ed_paciente.php">
                ...
                <div class="row form-group text-left">
                    ...
                    <div class="form-group text-left col-md-3">
                        ...
                        <br>
                        <input type="text" class="form-control" name="telefone" id="telefone" placeholder="Telefone" value="<?php echo $resultado1['telefone']; ?>" onkeypress="mascara(this, '## #####-####')" maxlength="14"/>
                    </div>
                    ...
                    <div class="form-group text-left col-md-3">
                        ...
                        <br>
                        <input type="text" class="form-control" name="rg" id="rg" placeholder="RG" size="20" value="<?php echo $resultado1['rg']; ?>" onkeypress="mascara(this, '##########-#')" maxlength="12"/>
                    </div>

                    <div class="form-group text-left col-md-3">
                        <label name="cpf">CPF</label>
                        <br>
                        <input type="text" class="form-control" name="cpf" id="cpf" placeholder="CPF" size="20" value="<?php echo $resultado1['cpf']; ?>"  onkeypress="mascara(this, '###.###.###-##')" maxlength="14"/>
                    </div>
                    ...
                    <div class="form-group text-left col-md-3">
                        ...
                        <br>
                        <input type="text" class="form-control" id="nacionalidade" name="nacionalidade" placeholder="Nacionalidade" value="<?php echo $resultado2['nacionalidade']; ?>" />
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label name="est_civil">Estado Civil</label>
                        <br>
                        <select class='form-control' data-size='5' id='est_civil' name='est_civil' >
                    ...
                    <div class="form-group text-left col-md-3">
                        ...
                        <br>
                        <input type="text" class="form-control" id="celular" name="celular" placeholder="Celular" value="<?php echo $resultado2['celular']; ?>"  onkeypress="mascara(this, '## #####-####')" maxlength="13"/>
                    </div>
                    <div class="form-group text-left col-md-6">
                        <label name="local_nascimento">Local de Nascimento</label>
                        <br>
                        <input type="text" class="form-control" id="local_nascimento" name="local_nascimento" placeholder="Local de Nascimento" value="<?php echo $resultado2['local_nascimento']; ?>" />
                    </div>
                    <div class="form-group text-left col-md-6">
                        <label name="nome_responsavel">Nome Responsável</label>
                        <br>
                        <input type="text" class="form-control" id="nome_responsavel" name="nome_responsavel" placeholder="Nome do Responsável" value="<?php echo $resultado2['nome_responsavel']; ?>" />
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label name="tel_responsavel">Telefone do Responsável</label>
                        <br>
                        <input type="text" class="form-control" id="tel_responsavel" name="tel_responsavel" placeholder="Telefone do Responsável" value="<?php echo $resultado2['tel_responsavel']; ?>"  onkeypress="mascara(this, '## #####-####')" maxlength="13"/>
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label name="profissao">Profissão</label>
                        <br>
                        <input type="text" class="form-control" id="profissao" name="profissao" placeholder="Profissão" value="<?php echo $resultado2['profissao']; ?>" />
                    </div>
                    <div class="form-group text-left col-md-6">
                        <label name="endereco">Endereço</label>
                        <br>
                        <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Endereço" value="<?php echo $resultado2['endereco']; ?>" />
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label name="bairro">Bairro</label>
                        <br>
                        <input type="text" class="form-control" id="bairro" name="bairro" placeholder="Bairro" value="<?php echo $resultado2['bairro']; ?>"  />
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label name="complemento">Complemento</label>
                        <br>
                        <input type="text" class="form-control" id="complemento" name="complemento" placeholder="Complemento" value="<?php echo $resultado2['complemento']; ?>" />
                    </div>
                    <div class="form-group text-left col-md-3">
                    ...
                    <div class="form-group text-left col-md-3">
                        ...
                        <br>
                        <input type="text" class="form-control" id="cidade" name="cidade" placeholder="Cidade" value="<?php echo $resultado2['cidade']; ?>"  />
                    </div>
                    <div class="form-group text-left col-md-3">
                        <label name="numero">Número</label>
                        <br>
                        <input type="text" class="form-control" id="numero" name="numero" placeholder="Número" value="<?php echo $resultado2['numero']; ?>"  />
                    </div>
